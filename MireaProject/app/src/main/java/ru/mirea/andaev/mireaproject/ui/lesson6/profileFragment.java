...
public class profileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        EditText surname = view.findViewById(R.id.editSurname);
        ...
        age.setText(preferences.getString("age", "0"));
        Button button = view.findViewById(R.id.submitButton);
        button.setOnClickListener(v -> {
            SharedPreferences.Editor editor = preferences.edit();
            String prof_name = name.getText().toString();
            String prof_surname = surname.getText().toString();
            String prof_age = age.getText().toString();

            editor.putString("name",prof_name);
            editor.putString("surname",prof_surname);
            editor.putString("age",prof_age);
